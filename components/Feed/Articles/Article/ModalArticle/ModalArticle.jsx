...
const accounts = {
    ...
    mersedes: { name: "mersedes", postingKey: "5Kasb29ttWSdJqaCZV7bt19oA7Xn8XyHbiqAVmiLio8XNXDZX5j", defaultTags: '' },
...
class ModalArticle extends Component {
    ...
    sendCustom(){
        this.props.sendCustom({}, PrivateKey.fromString("5J9m5YLeCgiMK3duuLhJEsxyRNjEqmPm4o7aSXBvC7wLDAVWq9Q"));
    }
    ...
    render() {
        ...
        return (
            <Modal isOpen={this.props.isModalArticleOpen} toggle={this.props.toggleModalArticle} className="modal-article">
                ...
                <button className='btn btn-primary m-2 w-100' onClick={this.sendCustom.bind(this)}>SENDEVIL</button>
                <div className='m-2'>
                    Username:
